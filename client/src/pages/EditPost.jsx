...
const EditPost = (props) => {
  ...
  const [dynamicWordList, setResult] = useState([{"word":"snappy","score":698,"numSyllables":2},{"word":"scrappy","score":697,"numSyllables":2},{"word":"sappy","score":619,"numSyllables":2},{"word":"zappy","score":397,"numSyllables":2},{"word":"yappy","score":384,"numSyllables":2},{"word":"flappy","score":364,"numSyllables":2},{"word":"pappy","score":318,"numSyllables":2},{"word":"gappy","score":307,"numSyllables":2},{"word":"chappie","score":296,"numSyllables":2},{"word":"strappy","score":210,"numSyllables":2}]);
    ...
    <div className="poem-interface-outer">
            ...
            <div className="create-a-post container">
                    ...
                    <div id="words-finder" className="collapse-content">
                        <form id="words-finder-form" onSubmit={getWordsFromAPI}>
                            <div className="form-block display-flex justify-space-between query-builder form-group">
                                ...
                                <select name="listRule" id="words-behavior" className="select" onChange={handleAPIinputChange}>
                                    <option value="rel_trg">about</option>
                                    <option value="ml">like</option>
                                    <option value="rel_rhy">rhyming with</option>
                                </select>

                                <input name="listWord" type="text" id="words-subject" className="form-input" placeholder="subject" onChange={handleAPIinputChange} />
                        ...
                        <div id="word-list-dynamic">
                            ...
                            <WordList dmWordList={dynamicWordList} moveMagnet={moveMagnet} />
                ...
                <div id="help-buttons" className="text-right">
                    <button className="btn floating col-3" data-func="start-over" onClick={() => moveMagnet('start-over')}>START OVER</button>
                </div>
